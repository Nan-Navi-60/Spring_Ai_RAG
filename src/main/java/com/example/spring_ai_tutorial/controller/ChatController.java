...
// 🚀 수정 1: Swagger 태그 설명에서 OpenAI 종속성 제거
@Tag(name = "Chat API", description = "Spring AI 표준 인터페이스를 통한 채팅 기능")
public class ChatController {
    ...
    // 🚀 수정 2: Swagger 오퍼레이션 설명 수정
    @Operation(summary = "LLM 채팅 메시지 전송",
            description = "사용자의 메시지를 받아 설정된 LLM(예: Gemini)을 통해 응답을 생성합니다.")
    ...
    public ResponseEntity<ApiResponseDto<Map<String, Object>>> sendMessage(
        ...
        try {
            // 🚀 수정 3: 이전에 리팩토링한 ChatService의 메서드명(chat)으로 변경
